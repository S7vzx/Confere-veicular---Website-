...
class ImageOptimizer {
  ...
  generateOptimizedSrc(
    ...
    // For lovable-uploads, apply query parameters
  ...
  static getCriticalImages(): string[] {
    return [
      '/lovable-uploads/fd5932e4-78b9-4795-af60-28883b4d0463.png', // Hero car
      '/lovable-uploads/f5472cd0-a719-4870-a846-6a0f274a9336.png', // Hero person
    ];
  }
